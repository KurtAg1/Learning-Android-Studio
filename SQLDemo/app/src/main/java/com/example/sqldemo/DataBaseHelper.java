...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public boolean updateOne(CustomerModel customerModel){
        ...
        int isActiveValue = customerModel.isActive() ? 1 : 0;

        String queryString = "UPDATE " + CUSTOMER_TABLE +" SET " +
                COLUMN_CUSTOMER_NAME + " = " + "'" + customerModel.getName() + "', " +
                COLUMN_CUSTOMER_AGE + " = " + "'" + customerModel.getAge() + "', " +
                COLUMN_ACTIVE_CUSTOMER + " = " + "'" + isActiveValue + "'" +
    ...
    public List<CustomerModel> getEveryone(String filter){
        List<CustomerModel> returnList = new ArrayList<>();

        // get data from the database

        String queryString = "SELECT * FROM " + CUSTOMER_TABLE + " WHERE " + COLUMN_CUSTOMER_NAME + " LIKE '%" + filter + "%'";
